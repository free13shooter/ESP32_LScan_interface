...
private:
        ...
        size_t r_available()
        {
            ...
            int count;
#if !SO_RCVBUF
        ESP_LOGE(TAG, "Enable SO_RCVBUF option in sdkconfig !!!");return 0;
#endif

#ifdef ESP_IDF_VERSION_MAJOR
            int res = lwip_ioctl(_fd, FIONREAD, &count); // Enable SO_RCVBUF option in sdkconfig !!!
#else
...
public:
    WiFiClientRxBuffer(int fd, size_t size=1437)
        :_size(size)
        ,_buffer(NULL)
        ,_pos(0)
        ,_fill(0)
